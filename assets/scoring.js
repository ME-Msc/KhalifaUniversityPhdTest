  ...
  return [
    {
      title: "奖学金",
      points: [
        "KU 奖学金：每月 AED 20,000，扣除约 AED 3,000/2,000 住宿费（取决于单人间或公用客厅房型）和学费后，每月约剩余 AED 14,500；生活成本（吃饭+适当娱乐）约 AED 3,000。",
        "KU-CSC 联合奖学金：KU 每月提供 AED 9,200，CSC 每月提供 USD 2,000；具体到账节奏、学费安排和补助结构以个人 offer、CSC 批件和 scholarship letter 为准。"
      ]
    },
    {
      title: "入学后 GPA 要求",
      points: ["KU 奖学金：每学期 GPA 低于 3.2 会停发奖学金。", "KU-CSC 联合奖学金：每学期 GPA 低于 3.5 会停发奖学金。"]
    },
    {
      title: "Writing Qualifying Exam",
      text: "类似国内博士资格考试。WQE 在入学第二学期考试，考三门本专业 KU 本科课程，2026 年通过率约 80%。第一次没过会停发 6 个月奖学金；第二次通过就恢复奖学金，第二次没过会退学。"
    },
    {
      title: "毕业要求",
      text: "全校博士毕业要求均为一篇 Q1 期刊。奖学金、WQE、GPA 和毕业要求信息按在读反馈整理，非官网承诺。"
    }
  ];
}
